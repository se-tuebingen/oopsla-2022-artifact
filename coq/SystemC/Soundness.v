...
<div class="source">
  ...
  <a href="{{site.github}}/blob/main/coq/SystemC/Soundness.v">Github</a>.
</div>
# *)
...
Proof with eauto 5 using styping_weaken_restriction, wf_vtyp_from_sig_binds.
  ...
  -- Case "Wind".
    ...
    - SCase "throw".
      ...
      * pick fresh X and apply typing_vabs...
        replace (open_es (plug (SystemC.Definitions.H l C h :: k) 0) X) with
          (plug (SystemC.Definitions.H l C h :: k) X)...
        {
